...
public class _02_PasswordChecker implements KeyListener {
     ...
     */
    static final String regexCriteria2 = "(?=\\D*\\d)";

    /*
     * 3. Check there is at least 1 capital letter
     */
    static final String regexCriteria3 = "(?=(?:[^A-Z]*[A-Z]){1})";
    ...
    static final String CRITERIA1 = "A minimum of 8 characters and a max of 20";
